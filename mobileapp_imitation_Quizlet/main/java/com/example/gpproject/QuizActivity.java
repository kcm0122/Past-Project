...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        option1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (selectedOptionByUser.isEmpty()) {
                    ...
                    revealAnswer();
                    questionsLists.get(currentQuestionPosition).setUserSelectAnswer(selectedOptionByUser);
                }
            }
        });
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (selectedOptionByUser.isEmpty()){
                    Toast.makeText(QuizActivity.this, "Please select ans", Toast.LENGTH_SHORT).show();
                } else {
                    changeNextQuestion();
                }
            }
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                quizTimer.purge();
                quizTimer.cancel();
                startActivity(new Intent(QuizActivity.this, start_quiz.class));
                finish();
            }
        });
    }
        ...
        quizTimer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                if(seconds == 0) {
                    ...
                    Toast.makeText(QuizActivity.this, "Out of time", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(QuizActivity.this, QuizResults.class);
                    intent.putExtra("correct",getCorrectAnswers());
                    intent.putExtra("incorrect",getInCorrectAnswers());
                    startActivity(intent);
    ...
    private int getCorrectAnswers() {
        ...
        for (int i = 0; i < questionsLists.size(); i++) {
            final String getUserSelectedAnswer = questionsLists.get(i).getUserSelectAnswer();
